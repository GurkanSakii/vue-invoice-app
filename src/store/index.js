...
export default createStore({
  ...
  mutations: {
    ...
    DELETE_INVOICE(state, payload) {
      state.invoiceData = state.invoiceData.filter((inv) => inv.docId !== payload);
    },
    UPDATE_STATUS_TO_PA(state, payload) {
    ...
    UPDATE_STATUS_TO_PEN(state, payload) {
        state.invoiceData.forEach((invoice) => {
          if (invoice.docId === payload) {
  ...
  actions: {
    ...
    async UPDATE_STATUS_TO_PAID({ commit }, docId) {
        ...
        commit("UPDATE_STATUS_TO_PA", docId);
      },
    ...
    async UPDATE_STATUS_TO_PENDING({ commit }, docId) {
        ...
        commit("UPDATE_STATUS_TO_PEN", docId);
    }
  },
  modules: {},
});
