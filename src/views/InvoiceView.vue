<template>
  <div v-if="currentInvoice" class="invoice-view container">
    <router-link class="nav-link flex" :to="{ name: 'HomeTo' }"> <img src="../assets/icon-arrow-left.svg" alt="" />Go Back </router-link>
    <div class="header flex">
      ...
      <div class="right flex">
        ...
        <button v-if="currentInvoice.invoicePending" class="green" @click="updateStatusToPaid(currentInvoice.docId)">Mark as Paid</button>
...
export default {
  ...
  methods: {
    ...
    getCurrentInvoice() {
      this.SET_CURRENT_INVOICE(this.$route.params.invoicesId);
